    ...
    var dialog = (function () {
        var //holds the list of used keys.
            ...
            templates = {
                ...
                body: '<div class="ajs-body">Esto es antes del body</div>',
        ...
        */
        ...
        return {
            ...
            notify: function (message, type, wait, callback) {
                return notifier.create(type, callback).push(
                `
                    <div class="mb-2">
            ...
            message: function (message, wait, callback) {
                return notifier.create(null, callback).push(
                `
                    <div class="mb-2">
                    <i class="fa fa-comments mr-2" aria-hidden="true"></i>
                        <b class="font-weight-bold"> Información !</b>
                    </div>
                    ${message}
                `, wait);
            },
            ...
            success: function (message, wait, callback) {
                return notifier.create('success', callback).push(
                `
                    <div class="mb-2">
            ...
            error: function (message, wait, callback) {
                return notifier.create('error', callback).push(
                `
                    <div class="mb-2">
            ...
            warning: function (message, wait, callback) {
                return notifier.create('warning', callback).push(
                `
                    <div class="mb-2">
