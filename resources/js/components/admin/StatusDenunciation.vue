        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-opacity-primary rounded-pill waves-effect" data-dismiss="modal" v-on:click="changeStatusDenunciation">Aceptar y cambiar</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            async changeStatusDenunciation(){
                this.loading(true);
                try {
                    await myFetch().get(`admin/denunciations/${this.denunciation.id}`);
