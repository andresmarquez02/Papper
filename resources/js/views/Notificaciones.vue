<template>
    <div class="pt-1 mt-5">
        <div class="m-0 mt-5 row d-flex justify-content-center">
            <div class="p-4 rounded shadow-sm col-10">
                ...
                <router-link class="py-3 dropdown-item" v-for="notificacion in $store.state.notificaciones" :key="notificacion.id"
