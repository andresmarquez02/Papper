...
@section('content')
    <div style="overflow-x: hidden">
        <div class="m-0 w-100 vh-100 d-flex justify-content-center align-items-center row bg-font">
            <div class="col-md-5">
                <h1 class="mb-1 text-center text-white font-weight-bold display-3">500</h1>
                <h1 class="text-center text-white font-weight-bold display-4">Uppsss...</h1>
                <h1 class="text-center text-white font-weight-bold">Ha ocurrido un error y estamos trabajando para solucionarlo</h1>
